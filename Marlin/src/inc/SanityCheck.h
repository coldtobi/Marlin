 ...
 */
  ...
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && !HAS_GRAPHICAL_LCD && DISABLED(EXTENSIBLE_UI) && DISABLED(DGUS_LCD)
  #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR, Graphical LCD, DGUS_LCD or EXTENSIBLE_UI."
#endif
