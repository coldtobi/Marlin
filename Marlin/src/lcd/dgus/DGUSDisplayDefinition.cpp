...
#include "../../inc/MarlinConfigPre.h"
  ...
  const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
    ...
    // Fan Data.
    #if FAN_COUNT > 0
      VPHELPER(VP_Fan_Percentage, &thermalManager.fan_speed[0], nullptr, &DGUSScreenVariableHandler::DGUSLCD_SendPercentageToDisplay),
    #endif
    ...
    // Print Progress.
    VPHELPER(VP_PrintProgress_Percentage, &MarlinUI_DGUS::progress_bar_percent, nullptr, &DGUSScreenVariableHandler::DGUSLCD_SendPercentageToDisplay ),

    // Feedrate.
    VPHELPER(VP_Feedrate_Percentage, &feedrate_percentage, nullptr, &DGUSScreenVariableHandler::DGUSLCD_SendWordValueToDisplay ),
